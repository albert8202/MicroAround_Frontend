      ...
      <nav class="navBar" style="z-index: 1">
        ...
        >
          <MenuItem name="home" router-link="{path: '/'}" style="width:9%" key="Home">
            <div class="over">
              <Icon type="ios-home" class="menuIcon"></Icon>
              <span class="menuWords">Home</span>
            </div>
          </MenuItem>
          <MenuItem
            name="notifications"
            router-link="{path: '/Notifications'}"
            style="width:13%"
            key="Notifications"
            @click.native="isRead"
          >
            <div class="over">
              <Icon type="ios-notifications" class="menuIcon"></Icon>
          ...
          <MenuItem name="message" router-link="{path: '/Message'}" style="width:11%" key="Message">
            <div class="over">
              <Icon type="ios-mail" class="menuIcon"></Icon>
              <span class="menuWords">Message</span>
            </div>
          </MenuItem>
          <MenuItem
            name="personal"
            router-link="{path: '/Personal'}"
            style="width:11%"
            key="Personal"
          >
            <div class="over">
              <Icon type="ios-person" class="menuIcon"></Icon>
              <span class="menuWords">Personal</span>
            </div>
          </MenuItem>
          <MenuItem name="explore" router-link="{path: '/Explore'}" style="width:10%" key="Explore">
            <div class="over">
              <Icon type="ios-eye" class="menuIcon"></Icon>
              <span class="menuWords">Explore</span>
            </div>
          </MenuItem>
          <Input
            v-model="model13"
